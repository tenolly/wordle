fetch(window.location.href + "get_server_time").then((response) => response.json()).then((json) => {
    ...
    document.getElementById("clock__seconds").style.transform = `rotate(${json.second * 6}deg)`;
})